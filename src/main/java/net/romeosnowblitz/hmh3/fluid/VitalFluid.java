...
public class VitalFluid extends FlowableFluid {
    public VitalFluid() {
    }

    public Fluid getFlowing() {
        return ModFluids.VITAL_FLUID_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.VITAL_FLUID_STILL;
    }

    public Item getBucketItem() {
        return ModItems.VITAL_FLUID;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) ModBlocks.VITAL_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.VITAL_FLUID_STILL || fluid == ModFluids.VITAL_FLUID_FLOWING;
    }
    ...
    public static class Flowing extends VitalFluid {
        public Flowing() {
        }
    ...
    public static class Still extends VitalFluid {
        public Still() {
        }
